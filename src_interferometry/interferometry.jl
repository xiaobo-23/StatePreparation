...
let
  ...
  # Sites to delete to set up the interferometry
  empty_sites = Set{Int64}([])            # The site number of the vacancy depends on the lattice width
  y_periodic = true
